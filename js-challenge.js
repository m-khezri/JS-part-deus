...
// const n = sonnet.indexOf("orphans");
// document.write('The position of orphans is ' + n);
// const l = sonnet.length;
// document.write('Number of character in sonnet are: ' + l);

console.log("Index of orphans", sonnet.indexOf("orphans"));

console.log("num of chars", sonnet.length);

newSonnet = newSonnet = sonnet.replace("winter", "yuletride");

newSonnet.replace(/ the /g, "a large ");

const sonnerDiv = document.getElementById('sonnet');
sonnerDiv.innerHTML = `<h3>${newSonnet}</h3>`;
